...
function Details1() {
  return (
    <div class="background">
      ...
      <div class="column1">
          <a href="/D5"><img src= {subplaceholder3} alt="Mountains" width="50" height="100"></img></a>
        </div>
        <div class="column2">
...
<h1 class=" text-left pl-9">Solar groen dak</h1>
  ...
  <p class="  p-2">Een solar groendak is de combinatie van zonnepanelen en groen op het dak. Met name op platte daken kan de temperatuur op warme daken wel oplopen tot 70 graden Celcius. Het rendement van zonnepanelen is echter optimaal bij een omgevingstemperatuur rond de 25 graden. Groendaken, voornamelijk met sedumplanten, houden de omgevingstemperatuur lager en daardoor verhoogt het rendement van de zonnepanelen tot wel 8%. 
