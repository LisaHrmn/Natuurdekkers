    ...
    <div className='text-center'>
      ...
      <div className='py-2 bg-gray-100'>
        <div className='pt-20 flex overflow-hidden'>
          <img src={plat} className='m-auto sm:w-1/3 h-auto transform hover:scale-125 z-50' alt='Plat dak'/>
          <img src={hellend} className='m-auto sm:w-1/3 h-auto transform hover:scale-125 z-50' alt='Hellend dak'/>
        </div>
