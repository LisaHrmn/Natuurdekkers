    ...
    <div className='text-center'>
      ...
      <div className='py-2 bg-gray-100'>
        <div className='pt-20 flex overflow-hidden'>
            <img src={plat} className='m-auto sm:w-1/3 h-auto transform hover:scale-125' alt='Plat dak'/>
            <img src={hellend} className='m-auto sm:w-1/3 h-auto transform hover:scale-125' alt='Hellend dak'/>
        </div>
          <div className="py-3 flex justify-around">
            <Link to={`/1/vlak`} className='py-2 px-4 text-green-600 border border-green-600 rounded-md hover:text-gray-200 hover:bg-green-600'>Plat dak</Link>
